...
const Contact = () => {
  ...
  return (
    <section className="py-20 bg-white dark:bg-gray-900" id="contact">
      ...
      {/* WhatsApp Button */}
      <motion.a
        href="https://wa.me/+917046110694?text=Hi"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-8 right-8 z-50 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all"
